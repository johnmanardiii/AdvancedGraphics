...
class SkinnedMesh
    ...
    public:
        ...
        void BoneTransform(double frametime, vector<mat4>& Transforms, float);
        void print_animation(int animation);
        void print_animations(int showall);
        void setBoneTransformations(GLuint shaderProgram, double currentTime, float);
        ...
        void SetNextAnimation(int nextanim)
            {
            if (nextAnimation == -1 && currentAnimation != nextanim)nextAnimation = nextanim;
            }
...
#define NUM_BONES_PER_VEREX 4
        ...
        struct BoneInfo
            ...
            mat4 AdditionalTransformation;  // used for custom bone animations in code
        ...
        void ReadNodeHeirarchy(const aiNode* pNode, const mat4& ParentTransform, double AnimationTime,double,
